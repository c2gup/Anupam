    ...
    <>
      ...
      >
        <div className="anu   inset-0  flex flex-col gap-20 items-center justify-center">
          ...
          <div>
            <button className="bg-[#feb901] text-3xl p-10 bg-opacity-5 text-yellow-700 hover:bg-[#feb901] hover:text-black mx-3 rounded-3xl border border-yellow-700 px-4 py-2">
              Resume
            </button>
